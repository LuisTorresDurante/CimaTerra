...
namespace CimaTerra.Content.Items.Summoner
{
    internal class MinionPacoBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<PacoMinion>()] > 0)
            {
    ...
    public class PacoStaff : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<MinionPacoBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<PacoMinion>(); // This item creates the minion projectile
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            player.AddBuff(Item.buffType, 180000);
    ...
    public class PacoMinion : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<MinionPacoBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<MinionPacoBuff>()))
            {
